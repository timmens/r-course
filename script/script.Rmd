...
where `file` is the location of the file to be imported^[Note that standard backslashes (the Windows default) do not work and need to be replaced by either forwardslashes or double backslashes, i.e. `"C:/R/cardata.csv"` or `"C:\\R\\cardata.csv"` instead of `"C:\R\cardata.csv"`)], `header` indicates whether the first line of the file contains variable names, `sep` is the field separator character, and `dec` is the character used in the file for decimal points.
